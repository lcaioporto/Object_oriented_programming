        ...
        while (true) { //Menu principal
            ...
            switch (op) {
                ...
                while (true) {
                    ...
                    print("2) Listar todos os sinistros da seguradora");
                    print("3) Visualizar um sinistro");
                    print("4) Remover um sinistro");
                    print("5) Listar todos os sinistros de um cliente");
                    print("6) Retornar ao menu principal");
                    print("==========================");
                    input_sinistro = Validacao.validainput(sc, 1, 6) + 18;
                    if (input_sinistro == 24) break;
                    ...
                    switch (op_sinistro) {
                        ...
                        case LISTAR_SINISTRO:
                            ...
                            check = seguradoraAtual.listarSinistros();
                            if (!check) {
                                print("========================================");
                        ...
                        case ACESSAR_SINISTRO:
                            ...
                            check = seguradoraAtual.visualizarSinistro(id);
                            if (!check) {
                                print("========================================");
                        ...
                        case LISTA_SINISTRO_CLIENTE:
                            print("=======================================");
                            print("Abaixo insira as informações do cliente");
                            print("=======================================");
                            seguradoraAtual.listarSinistroCliente(sc);
                            break;
                        default:
                            print("==============================================");
                            print("Selecione apenas entre as opções apresentadas!");
