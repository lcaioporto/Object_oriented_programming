...
public class MenuSeguradora {
    ...
    public static void MenuInterativo (Scanner sc, Seguradora seguradoraInicial) {
        ...
        //Seguradora inicial (já inicializada na AppMain)
        Seguradora seguradoraAtual = seguradoraInicial;
        ...
        while (true) { //Menu principal
            ...
            switch (op) {
                ...
                case MENU_SEGURO: // Menu do Seguro
                    while (true) {
                        print("====== SEGURO ======");
                        print("O que você deseja fazer?");
